    ...
    <>
      <main>
        <div className="images">
          <img id="tomorrowland" src="/tomorrowland.png" alt="" srcset="" />
          <img id="navy-pier" src="/navy-pier.png" alt="" srcset="" />
          <img id="msi-chicago" src="/msi-chicago.png" alt="" srcset="" />
          <img id="phone" src="/phone.png" alt="" srcset="" />
          <img id="kikk" src="/kikk.png" alt="" srcset="" />
          <img id="kennedy" src="/kennedy.png" alt="" srcset="" />
          <img id="opera" src="/opera.png" alt="" srcset="" />
        </div>
        ...
        <section id="section-1">
          ...
          <div className="bottom">
            ...
            <div className="right">
              <p>
                We are a dog studio based in
                <br />
                New York City. We specialize in <br />
                creating custom dog breeds.
              </p>
            </div>
          </div>
        ...
        <section id="section-3">
          <div className="top">
            <div className="left">
              <h3>Lorem ipsum dolor sit <br /> amet consectetur <br /> adipisicing elit. <br />Necessitatibus, veniam?</h3>
            </div>
            <div className="right"></div>
          </div>
        ...
        <section id="section-4">
          <div className="bottom">
            <div className="left"></div>
            <div className="right">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est dignissimos totam dolorem voluptates aperiam, dolore exercitationem! Impedit labore magnam perspiciatis?</p>
              <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Pariatur, maiores veritatis doloribus numquam corporis eligendi placeat! Tempora excepturi eligendi sapiente?</p>
            </div>
          </div>
        </section>
      </main>
